"""TechMart AI Support — Specialized Agents (Billing, Technical, Product, Complaint, FAQ)"""
...
class BillingAgent(BaseAgent):
    """Handles: payment issues, subscriptions, invoices, refunds, pricing.Primary sources: pricing.txt, refund_policy.txt"""
...
class TechnicalAgent(BaseAgent):
    """Handles: device setup, troubleshooting, software errors, password resets, firmware updates, connectivity issues, factory resets. Primary sources: installation_guide.txt, user_manual.txt, warranty.txt"""
...
class ProductAgent(BaseAgent):
    """Handles: product features, specs, comparisons, availability, recommendations. Primary sources: products.txt, pricing.txt"""
...
class ComplaintAgent(BaseAgent):
    """Handles: customer complaints, dissatisfaction, escalations, apologies. Primary sources: refund_policy.txt, warranty.txt, faq.txt"""
...
class FAQAgent(BaseAgent):
    """Handles: general questions, company policies, contact info, account help, shipping questions, general inquiries not fitting other agents. Primary sources: faq.txt, shipping_policy.txt"""
