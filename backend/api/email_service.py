...
def send_escalation_emails(
    ...
    customer_email: str,
    session_id: str,
    session_title: str = "Support Query"
) -> dict:
    """
    Send two emails when customer escalates to human agent:
    1. Confirmation email to customer
    2. Alert email to support team
    """
...
def send_ticket_created_email(
    ...
    """Send email when a support ticket is auto-created."""
...
def send_feedback_thank_you(
    customer_name: str,
    customer_email: str,
    rating: int,
) -> bool:
    """Send thank you email after customer submits feedback."""
